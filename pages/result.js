    ...
    <div className="min-h-screen bg-[#edf4ef] text-[#203128] px-5 py-10">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <section className="bg-white/70 border border-[#dbe6de] rounded-[30px] px-8 py-8 shadow-[0_16px_34px_rgba(31,45,38,0.05)] mb-8">
          ...
          <a
  href={`https://creatorapp.zohopublic.in/madhur_moodforest755/moodforest-app/form-perma/Journey_Continuity/6VVUAhPr5jeVrEeBpvW9b17WaxH4j3PHJ0Ku5wFSVwY4k8C1Pm6Me05nJ4dvmxwJPUdZe9nFOZsFmmHOK5q8F4Nzr0uVCN2Y2Htp?score=${score}&state=${state}&insight=${insight}`}
  target="_blank"
